...
impl From<Color> for TilePbrMaterial {
...
impl From<Handle<Image>> for TilePbrMaterial {
...
impl From<&TilePbrMaterial> for StandardMaterialKey {
    fn from(material: &TilePbrMaterial) -> Self {
        StandardMaterialKey {
...
impl Material for TilePbrMaterial {
    fn specialize(
        ...
        let vertex_layout = layout.get_layout(&[
            ...
            ATTRIBUTE_TILE_ORDER.at_shader_location(3),
        ])?;
        ...
        if let Some(label) = &mut descriptor.label {
            *label = format!("tile_pbr_{}", *label).into();
        }
    ...
    fn prepass_vertex_shader() -> ShaderRef {
        "shaders/tile_pbr_vertex_pre.wgsl".into()
    }
