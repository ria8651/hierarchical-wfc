...
struct Vertex {
    @location(0) position: vec3<f32>, // 0 1 2
    @location(1) normal: vec3<f32>,   // 3 4 5
    @location(2) uv: vec2<f32>,       // 6 7
    @location(3) order: u32,
    // @location(3) tangents: mat4x4<f32>, // 8 9 10 11 
...
fn vertex(vertex: Vertex) -> MeshVertexOutput {
    ...
    let pos = mesh_position_local_to_clip(
        mesh.model,
